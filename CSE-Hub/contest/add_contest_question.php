...
<html>
<head>
    <title>Add Contest Question</title>
    <link rel="stylesheet" type="text/css" href="css/stylesheet.css" media="screen">
</head>
<body>
    <header>
        <p>
            <h1>Add Contest Question</h1>
        </p>
    ...
    <section class="outer-section">
        ...
        <section class="middle-pane">
            ...
            <div class="container">
                ...
                <form action = "add_contest_question.php" method = "post">
                type total number of testcases you want to add for the question in contest and click go.
                    <?php
                    echo <<<_END
...
_END;
                ...
                <form action="finish.php">
                    <input type="submit" value="finish"/></button>
                </form>
                </br>
                </br>
            </div>
